import { Menu, X, Shield, FileDown, FileUp, Github, RotateCcw } from 'lucide-react';
      ...
      {mobileMenuOpen && (
        <div className="sm:hidden bg-white border-b shadow-lg">
          <div className="max-w-7xl mx-auto px-4 py-3 space-y-2">
            ...
            <label className="flex items-center gap-3 w-full px-3 py-2 text-sm text-gray-700 hover:bg-gray-50 rounded-lg transition-colors cursor-pointer">
